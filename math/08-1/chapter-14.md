...
这也是一个分解因数的过程, 分解步骤是:  
1. 12 试除 2, 可以被整除得到 6, 所以第一个被分解出来的因数是 2 
2. 6 试除 2, 可以被整除得到 3, 所以第二个被分解出来的因数是 2  
3. 3 试除 3, 可以被整除得到 1, 所以第三个被分解出来的因数是 3  

所以 12 的质因数分解是 $ 2 * 2 * 3 = 2^2 * 3 $ 
...
1. 1001 试除 2, 不可以被整除, 继续找第一个因数.  
2. 1001 试除 3, 不可以被整除, 继续找第一个因数.  
3. 1001 试除 5, 不可以被整除, 继续找第一个因数.  
4. 1001 试除 7, 可以被整除得到 143, 所以第一个被分解出来的因数是 7  
5. 143 试除 9, 不可以被整除, 继续找第二个因数.   
6. 143 试除 11, 可以被整除得到 13, 所以第二个被分解出来的因数是 11  
7. 13 试除 13, 可以被整除得到 1, 所以第三个被分解出来的因数是 13  

所以 1001 的质因数分解是 $ 7 * 11 * 13 $  
